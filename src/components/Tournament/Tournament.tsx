...
const mockTournament: Round[] = [
  {
    roundName: "Round 1",
    matches: [
      { matchNumber: 1, playerOne: { address: DEFAULT_0X0_ADDRESS, score: 2 }, playerTwo: { address: DEFAULT_0X0_ADDRESS, score: 0 }, winner: 1 },
      { matchNumber: 2, playerOne: { address: DEFAULT_0X0_ADDRESS, score: 2 }, playerTwo: { address: DEFAULT_0X0_ADDRESS, score: 1 }, winner: 1 },
      { matchNumber: 3, playerOne: { address: DEFAULT_0X0_ADDRESS, score: 1 }, playerTwo: { address: DEFAULT_0X0_ADDRESS, score: 2 }, winner: 2 },
      { matchNumber: 4, playerOne: { address: DEFAULT_0X0_ADDRESS, score: 0 }, playerTwo: { address: DEFAULT_0X0_ADDRESS, score: 0 }, winner: 0 },
    ],
  },
  {
    roundName: "Round 2",
    matches: [
      { matchNumber: 3, playerOne: { address: DEFAULT_0X0_ADDRESS, score: 0 }, playerTwo: { address: DEFAULT_0X0_ADDRESS, score: 0 }, winner: 0 },
      { matchNumber: 4, playerOne: { address: DEFAULT_0X0_ADDRESS, score: 0 }, playerTwo: { address: "TBD", score: 0 }, winner: 0 },
    ],
  },
  {
    roundName: "Round 3",
  ...
  return (
    <>
      ...
      <div className="space-y-8 p-4 md:ml-64 pt-14 h-screen relative w-auto min-w-fit flex flex-col bg-[#27272b] mx-auto text-white" id="app">
        <div className="brackets-canvas p-0 lg:p-20">
